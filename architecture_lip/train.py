...
parser.add_argument('--normalize', dest='normalize', default=False, type=bool)
...
if not save_path:
    save_path=f'result/{epsilon}/'
    if not os.path.exists(save_path):
        os.makedirs(save_path,exist_ok=True)

train_loader,test_loader=get_MNIST(batch_size_train,batch_size_test,classes=num_classes)
